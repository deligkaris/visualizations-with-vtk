...
vtkContourFilter contourSkin
	...
	contourSkin GenerateValues 1 60.0 60.0
...
vtkContourFilter contourBone
	...
	#to show the bone the isosurface value of 115 seems to be fine
        #use either of the following
        contourBone GenerateValues 1 115.0 115.0
        #contourBone SetNumberOfContours 1
        #contourBone SetValue 0 115.0
