...
# dataset using streamlines. To find good positions for the 
# seeds we used our streamLinesWithSlider.tcl code
#
#############################################################
...
#we also used seeds that are arranged on a plane
...
vtkPolyDataMapper mapper1
	mapper1 SetInputConnection [streamer1 GetOutputPort]
